...
上次文档刷新时的主线快照（`3793b83`）已包含 internal.toml 真源迁移（U0/`159b78b`）及本机双 daemon
...
r5 worktree 仍 dirty，尚无 candidate commit；它只保留为只读审计/证据源，必须从届时最新远端主线
...
从旧主线 `ce91c14` 建立，相对上述历史快照已落后，不能作为最新主线 admission；
