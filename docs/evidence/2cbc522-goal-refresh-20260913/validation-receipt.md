...
- Base: `origin/main@412fc5fbc7bba328d9916906122192d4e7e60e2b8`.
- `git diff --check`: PASS.
- `pnpm verify`: PASS.
...
- Runtime baseline proof: `git -C playground/3742b9a-runtime-rebind-20260913 merge-base HEAD origin/main` returned `412fc5fbc7bba328d9916906122192d4e7e60e2b8`; candidate parent commits remain part of the same branch above that current base.
