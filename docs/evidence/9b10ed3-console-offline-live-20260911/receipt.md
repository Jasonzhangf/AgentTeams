...
The temporary replay controller used these generated Node entrypoint names:
...
The retained evidence records the consumer runtime/controller PID as `50440`. The temporary controller and generated runtime artifacts were removed after the replay; their build hashes and separate controller source were not retained.
