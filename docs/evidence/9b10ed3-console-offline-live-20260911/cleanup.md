...
- shutdown evidence: the replay controller stopped the consumer runtime and all child process handles exited; Relay/provider/Console exits were code `0`; Console 1's retained exit was code `0` with no signal field
